...
namespace Forge.Migrations
{
    ...
    [Migration("20260828233759_AddNotificationIdentityUserId")]
    partial class AddNotificationIdentityUserId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Forge.Authors.Author", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Forge.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LostFound.Conversations.Conversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ReportId", "Participant1Id", "Participant2Id")
                        .IsUnique();

                    b.ToTable("LostFoundConversations", (string)null);
                });

            modelBuilder.Entity("LostFound.Conversations.ConversationMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("LostFoundConversationMessages", (string)null);
                });
            ...
            modelBuilder.Entity("LostFound.Matches.ReportClaim", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal?>("ObservedScorePercentage")
                        .HasColumnType("decimal(5,2)");
                    ...
                    b.HasIndex("ReportId", "ClaimantUserId");

                    b.ToTable("LostFoundReportClaims", (string)null);
                });
            ...
            modelBuilder.Entity("LostFound.Reporters.ReporterClaimToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("LostFoundReporterClaimTokens", (string)null);
                });
            ...
            modelBuilder.Entity("Forge.Books.Book", b =>
                {
                    b.HasOne("Forge.Authors.Author", null)
                        .WithMany()
            ...
            modelBuilder.Entity("LostFound.Conversations.ConversationMessage", b =>
                {
                    b.HasOne("LostFound.Conversations.Conversation", null)
                        .WithMany("Messages")
