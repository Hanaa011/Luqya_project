...
namespace Forge.Books;

[Authorize(ForgePermissions.Books.Default)]
public class BookAppService : ApplicationService, IBookAppService
{
    ...
    [Authorize(ForgePermissions.Books.Create)]
    ...
    [Authorize(ForgePermissions.Books.Edit)]
    ...
    [Authorize(ForgePermissions.Books.Delete)]
