...
```bash
ng build lost-found --watch
```

## Code scaffolding

Run `ng generate component component-name --project lost-found` to generate a new component in the library.
...
```bash
npm install @lost-found
```

2. Import the module in your application:
```typescript
import { LostFoundModule } from '@lost-found';
